            ...
            if (showBottomBar) {
                NavigationBar(
                    ...
                    val filledIcons = mapOf(
                        Dest.FEED to Icons.Filled.Home,
                        Dest.SEARCH to Icons.Filled.AutoAwesome,
                        Dest.ZYNX to Icons.Filled.PlayCircle,
                        Dest.MESSAGES to Icons.Filled.Send,
                        Dest.NOTIFICATIONS to Icons.Filled.Notifications
                    )
                    val outlinedIcons = mapOf(
                        Dest.FEED to Icons.Outlined.Home,
                        Dest.SEARCH to Icons.Outlined.AutoAwesome,
                        Dest.ZYNX to Icons.Outlined.PlayCircle,
                        Dest.MESSAGES to Icons.Outlined.Send,
                        Dest.NOTIFICATIONS to Icons.Outlined.Notifications
                    )
                    BOTTOM_TABS.forEach { tab ->
                        ...
                        NavigationBarItem(
                            ...
                            icon = {
                                Icon(
                                    imageVector = if (selected) filledIcons[tab.route]!! else outlinedIcons[tab.route]!!,
